...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      audit_logs: {
        Row: {
          ...
          new_data: Json | null
          old_data: Json | null
          role_used: Database["public"]["Enums"]["user_role"] | null
      ...
      mahallas: {
        ...
        Relationships: [
          {
            foreignKeyName: "mahallas_district_id_fkey"
            columns: ["district_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "mahallas_region_id_fkey"
            columns: ["region_id"]
            isOneToOne: false
            referencedRelation: "regions"
            referencedColumns: ["id"]
      ...
      medical_objects: {
        ...
        Relationships: [
          {
            foreignKeyName: "medical_objects_district_id_fkey"
            columns: ["district_id"]
            isOneToOne: false
            referencedRelation: "districts"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "medical_objects_mahalla_id_fkey"
            columns: ["mahalla_id"]
            isOneToOne: false
            referencedRelation: "mahallas"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "medical_objects_region_id_fkey"
            columns: ["region_id"]
            isOneToOne: false
            referencedRelation: "regions"
            referencedColumns: ["id"]
      ...
      moderation_requests: {
        ...
        Relationships: [
          {
            foreignKeyName: "moderation_requests_object_id_fkey"
            columns: ["object_id"]
            isOneToOne: false
            referencedRelation: "medical_objects"
            referencedColumns: ["id"]
          },
        ]
      }
    ...
    Functions: {
      ...
      expire_password_reset_requests: { Args: never; Returns: undefined }
    ...
    Enums: {
      ...
      moderation_request_type: "update" | "delete" | "archive" | "restore"
      moderation_status:
        | "draft"
        | "pending_review"
        | "approved"
        | "rejected"
        | "needs_changes"
      ownership_type: "Davlat" | "Xususiy" | "Aralash" | "Noma'lum"
      user_role:
        | "super_admin"
        | "admin"
        | "moderator"
